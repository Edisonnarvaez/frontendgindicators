            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {headquarters.map((headquarter) => (
                <tr key={headquarter.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">{headquarter.nit}</td>
                  <td className="px-6 py-4 whitespace-nowrap">{headquarter.legalRepresentative}</td>
                  <td className="px-6 py-4 whitespace-nowrap">{headquarter.phone}</td>
